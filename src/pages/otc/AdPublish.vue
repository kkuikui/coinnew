                    ...
                    <Form ref="form" :model="form" :rules="ruleValidate" :label-width="90">
                        ...
                        <FormItem :label="$t('otc.publishad.exchangecoin')" prop="coin">
                            <Select v-model="form.coin" :disabled='isId' @on-change="changeCoin">
                                <Option v-for="(item, index) in coinList" :key="index" :value="item.id">{{item.unit}}</Option>
                            </Select>
                        </FormItem>
                        ...
                        <FormItem :label="$t('otc.publishad.exchangeprice')" prop="price" class="pricecss">
                        ...
                        <router-link to="/uc/account" class="tips">{{$t('otc.publishad.tip2')}}</router-link>
                        ...
                        <FormItem class="buttoncss">
                            <button class="buttonstyle" long @click.prevent="handleSubmit('form')" :disabled="disAllowBtn">{{$t('otc.publishad.submit')}}</Button>
