...
var WebsockFeed = function (url, coin, stompClient, scale) {
  ...
  this.subscribe = true;
  this.scale = scale;
  this.baseCoinScale = localStorage.getItem('baseCoinScale') || 7
};
...
WebsockFeed.prototype.resolveSymbol = function (symbolName, onSymbolResolvedCallback, onResolveErrorCallback) {
  ...
  var data = {
    ...
    "pricescale": Math.pow(10, this.scale || this.baseCoinScale),
    "ticker": "",
...
WebsockFeed.prototype.baseCoinScaleFunc = function (coin) {
  this.baseCoinScale = coin
}
