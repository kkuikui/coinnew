module.exports = {
  ...
  exchange: {
    ...
    buyamounttipwarningNum: 'Please enter the correct number!',
    canuse: 'Available',
    recharge: 'Recharge',
    buyprice: 'Buy Price',
    buynum: 'Buy Amount',
  ...
  otc: {
    ...
    unapplymerchant: 'Application for refund',
    volume: 'Volume',
    ...
    chat: {
      ...
      comptImage:"Complaint image",
      compremark: 'Complaint note',
      willcomp: 'I want to complain',
      msg6: 'Do you confirm currency release?',
      result_1: 'Waiting for payment, within ',
      result_11: 'please complete the payment',
      result_2: 'Waiting for release',
      result_3: 'Payment completion',
      result_4: 'Appealing',
      result_5: 'Canceled',
      msg7: 'Fund Password',
    ...
    index: {
      ...
      sell: 'sell',
      viewmore: 'More',
      bot1: 'Freedom of sale',
      bot1_tip: 'Currency and over-the-counter transactions supporting multiple digital currencies,Trade freedom, two-way transaction, quick and convenient',
      bot2: 'Safe and reliable',
      bot2_tip: 'Bank level security technologies such as cold storage, SSL, multiple encryption, etc.Ten years financial security team, multiple guarantee asset safety',
      bot3: 'Transaction convenience',
      bot3_tip: 'Support multi terminal transactions, WEB, APP market timely grasp, Fast trading, caring service, global market, easy anytime, anywhere',
      ibuy: 'I want buy',
      isell: 'I want sell',
      choosewhy: 'Why should we choose Convenient To Go ?',
      thereason: 'We allow people from different countries to exchange digital money conveniently and quickly.'
    }
  },
  uc: {
    login: {
    ...
    finance: {
      ...
      record: {
        ...
        match: 'Match',
        deposit: "deposit",
        get_back_deposit: "getbackdeposit",
        three1:"DY—Chain transfer",
        three2:"DY—Chain turns out",
        legalrecharge: "legalrecharge",
        assetexchange: "assetexchange",
        channelaward: "channelaward",
        airdrop: "airdrop",
      ...
      recharge: {
        ...
        msg10: "currency, recharge less than the minimum amount will not be accounted.",
      ...
      withdraw: {
        ...
        tipaddress: 'The address is empty. Please go to the money address management office to add it.',
        ...
        status_3: 'Failure',
        status_4: 'Success',
        status_5:"In making money",
        remark: 'Remark',
        add: 'Add',
        addresslist: 'Coin address record',
      ...
      buyCTGC: {
        ...
        num: 'Amount',
        arriamount: 'The number of arrivals',
        transRate: 'Conversion ratio',
        buy: 'buy',
        avabalance: 'Available Balance',
        tip1: 'Please enter the correct number'
      }
    },
    member: {
    ...
    //   upload_hand: 'Upload handheld ID photos',
      upload_hand: 'Upload the face of the original id card and personal signature',
      imgtips1:'Please upload a photo with the front of the original id card held in hand and the handwritten content of "coin-dy.com" and the current date',
      imgtips2:"Please make sure that the contents of the photos and personal handwriting are clearly visible. Only JPG and PNG image formats are supported, and the image size is less than 2M",  
      save: 'Save',
      reset: 'Reset',
      email: 'Email',
      ...
      upload_handtip: 'Upload the face of the original id card and personal signature',
    ...
    otcorder: {
      ...
      canceled: 'Canceled',
      appealing: 'Appealing',
      searchtip: 'Please enter the order number',
      orderno: 'OrderNo',
      created: 'Time',
      symbol: 'Coin',
      type: 'Type',
    ...
    identity: {
      ...
      applytip: 'Apply for Certified Business and Enjoy More Transaction Privileges',
      applying: 'Your business authentication audit has been submitted',
      applyed: 'Congratulations! Your business authentication audit has passed',
      failapply: 'Sorry! Your business authentication audit failed to pass',
      cancelling: 'Your business cancellation application has been submitted',
      failcancel: 'Your business cancellation application is not approved',
      cancelled: 'Your business cancellation application has been passed',
      rightget: 'You have the following rights',
      right1: 'Businessmen enjoy exclusive advertising booths to increase the success rate of transactions',
      right2: 'We will provide one to one exclusive service to the merchant',
      right3: 'Enjoy lower transaction fees',
      ...
      waitres: 'Wait for the result',
      certified: 'Certified',
      adfail: 'Audit failure',
      cancelmer: 'Merchant cancellation',
      submission: 'Submission',
      resub: 'Reexamination',
      reapply: 'Reapply',
      adapply: 'Advertise',
      refunapply: 'Application for refund',
      reason: 'Reason',
      ...
      howapply: 'How to apply for a Certified Business？',
      step1: 'Step 1: prepare business application information as required',
      step2: 'Step 2: submit an application',
      step3: 'Step 3: data review',
      step1tip: 'Prepare the following application information',
      step1tip1: 'Mobile phone number, micro signal, QQ number, personal digital assets Certificate (picture), digital assets transaction certificate (picture)',
      step2tip: 'Complete the business certification audit data that needs to be filled and uploaded, click submit audit.',
      step3tip: 'We will check the application information of your business within 3-5 working days. Please pay attention to the audit status at any time. You can check it on the submission page. After the audit is passed, you can publish advertisements in the French currency trading area.',
      agreefreeze: 'Freeze',
      fordeposit: 'As merchant deposit',
      one: '  ',
      or: '  or  ',
      upload: 'Upload',
      forapply: 'Apply',
      subinfor: 'Submitting business authentication information',
      subtip1: 'Upload the prepared merchant authentication data to the platform and submit it.',
      coinsym: 'Guarantee gold coin',
      chosym: 'Choice of currency',
      marginum: 'Amount of margin',
      assetpro: 'Personal digital asset proof',
      assetcer: 'Certificate of digital asset transaction',
      loggouttip: 'You are in the process of logging out, and you will not be able to cancel the application.',
      sureop: 'Do you confirm that this operation is performed',
      filreason: 'Please fill in the cause of cancellation',
  ...
  cms: {
    ...
    newhelp: {
      newstart: 'Getting started',
      faq: 'Common problem',
      reguide: 'Recharge Guide',
      trguide: 'Trade Guide'
    },
  ...
  description: {
    ...
    message3: 'Bidui Exchange supports 10,000 transactions per second, giving users a hearty transaction experience',
    message4: 'Multi terminal APP, easy trading between square inches',
    message5: 'Bidui exchange mobile exchange client, focusing on palm trading experience',
    message6: '100000+',
    message7: 'BIDUI EXCHANGE',
    message8: 'Iphone Download',
    message9: 'Android Download'
  },
  footer: {
    gsmc: 'Bidui exchange',
