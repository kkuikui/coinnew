module.exports = {
  ...
  exchange: {
    ...
    success: '提交成功',
    buyamounttipwarningNum: '请输入正确的价格!',
    pricetip: '请输入交易额',
  ...
  otc: {
    ...
    index: {
      ...
      viewmore: '查看更多',
      bot1: '买卖自由',
      bot1_tip: '支持多种数字货币的币币交易与场外交易，买卖自由，双向交易，快速方便',
      bot2: '安全可靠',
      bot2_tip: '冷存储、SSL、多重加密等银行级别安全技术，十年金融安全团队，多重保障资产安全',
      bot3: '交易便捷',
      bot3_tip: '支持多终端交易，WEB、APP行情及时掌握，快速交易，贴心服务，全球市场，交易随时随地',
      ibuy: '我要买入',
      isell: '我要卖出',
      choosewhy: '为什么要选择Convenient To Go ？',
      thereason: '我们让来自不同国家的人都可以方便快捷的交易数字货币'
    }
  },
  uc: {
    login: {
    ...
    safe: {
      ...
      upload_hand: '上传手持身份证照原件正面照和个人签名',
      imgtips1:'请你上传一张手持身份证原件正面和个人手写的照片,个人手写的内容包含"coin-dy.com"和当前日期',
      imgtips2:"请确保照片和个人手写的内容清晰可见，仅支持jpg和png图片格式，图片大小小于2M",  
      ...
      upload_handtip: '上传手持身份证照原件正面照和个人签名',
      save_success: '保存成功!',
      save_failure: '保存失败!',
    },
    account: {
    ...
    identity: {
      apply: '商家申请',
      applytip: '申请成为认证商家，享受更多交易特权',
      applying: '您的商家认证审核已提交',
      applyed: '恭喜！您的商家认证审核已通过',
      failapply: '抱歉！您的商家认证审核未通过',
      cancelling: '您的商家注销申请已提交',
      failcancel: '您的商家注销申请审核未通过',
      cancelled: '您的商家注销申请已通过',
      rightget: '您获得以下权限',
      right1: '商家享有专属广告展位，增加交易成功率',
      right2: '我们将向商家提供一对一专属服务',
      right3: '享受更低交易手续费',
      seat: '专属展位',
      service: '一对一服务',
      lowfee: '更低手续费',
      ...
      howapply: '如何申请成为商家？',
      step1: '步骤一：按要求准备商家申请资料',
      step2: '步骤二：提交申请',
      step3: '步骤三：资料审核',
      step1tip: '准备如下申请资料',
      step1tip1: '手机号、微信号、QQ号、个人数字资产证明(图片)、数字资产交易证明(图片)',
      step2tip: '完成需要填写和上传的商家认证审核资料，点击提交审核。',
      step3tip: '我们将在3-5个工作日内对您的商家申请资料进行审核，请随时关注审核状态，可在提交页面查看。审核通过后，您即可在法币交易区发布广告。',
      agreefreeze: '同意冻结',
      fordeposit: '作为商家保证金',
      one: '个',
      or: '或',
      ...
      forapply: '申请成为商家',
      subinfor: '提交商家认证资料',
      subtip1: '请您将准备好的商家认证资料上传至平台并提交',
      coinsym: '保证金币种',
      chosym: '选择币种',
      marginum: '保证金数量',
      assetpro: '个人数字资产证明',
      assetcer: '数字资产交易证明',
      loggouttip: '您正在进行商家注销操作，确认提交申请操作后，将无法撤销。',
      sureop: '是否确认执行此操作',
      filreason: '请填写取消原因',
    },
    extension: {
  ...
  description: {
    message1: 'SSL、动态身份验证等银行级别安全技术，保障交易安全；支持多种数字货币交易',
    message2: '严格的项目准入门槛，确保平台用户利益；100%保证金，钱包冷热隔离，确保用户资金安全',
    message3: '币对数字资产交易平台支持每秒10000笔交易，给用户带来酣畅淋漓的交易体验！',
    message4: '多终端APP，方寸间轻松交易',
    message5: '币对交易所手机客户端，专注掌上交易体验',
    message6: '100000+',
