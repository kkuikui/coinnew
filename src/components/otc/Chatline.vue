        ...
        <div class="chat-line">
            <div class="scroll-chat" id="scrollChat">
                <div class="chat-container-box" id="sysbox">
                    <div class="system-box">
                        <p class="msg-content" v-show="statusBtn==1">{{$t('otc.chatline.status_1')}}</p>
                        <p class="msg-content" v-show="statusBtn==2">{{$t('otc.chatline.status_2')}}</p>
                        <p class="msg-content" v-show="statusBtn==3">{{$t('otc.chatline.status_3')}}</p>
                        <p class="msg-content" v-show="statusBtn==4">{{$t('otc.chatline.status_4')}}</p>
                        <p class="msg-content" v-show="statusBtn==0">{{$t('otc.chatline.status_5')}}</p>
                    </div>
                </div>
          ...
          <div class="audio-wrap">
            ...
            <div class="send-msg-box">
                ...
                <textarea v-model="mytext" @keyup.enter="sendName"
                 autocomplete="off" type="text" :placeholder="$t('otc.chatline.contenttip')"
                  style=" background-attachment: scroll; background-size: 16px 18px; background-position: 98% 50%;"></textarea>
...
@import '../../styles/common.less';
  .user-avatar-public{
	...
	box-shadow: 0 1px 5px 0 @borderLine;
    .user-avatar-in{
	    .ball(45px, @avatarColor);
	    .font(16px, #fff, center, 45px);
	    .center; 
...
.chat-container-box .user-chat-box .user-content-box .chat-info .self-desc .icon {
    ...
    width: 0;
    border: 8px solid transparent;
    border-left: 14px solid @avatarColor;
    position: absolute;
    top: 6px;
    right: -18px;
    left: unset;
...
.chat-in-box .chat-in .chat-line .send-msg-box textarea {
    resize: none;
    height: 88px;
